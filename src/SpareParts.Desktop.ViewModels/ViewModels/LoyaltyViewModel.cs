...
namespace SpareParts.Desktop.Wpf.ViewModels
{
    public sealed class LoyaltyViewModel : INotifyPropertyChanged
    {
        ...
        private string _status = "Load top loyalty customers.";
        private Brush _statusBrush = Brushes.LightGray;

        public LoyaltyViewModel(ICrudApiClient crudApi)
        {
            _crudApi = crudApi;
        ...
        public ObservableCollection<CustomerLoyaltyDto> Items { get; } = new();
        ...
        {
            IsLoading = true;
            Status = "Loading loyalty data...";
            StatusBrush = Brushes.LightGray;
            try
            {
                var items = await _crudApi.GetAllAsync<CustomerLoyaltyDto>("api/loyalty/customers/top");
                Items.Clear();

...
{
    public sealed class WarrantyClaimsViewModel : INotifyPropertyChanged
    {
        private readonly ICrudApiClient _crudApi;
        private bool _isLoading;
        private string _status = "Load warranty claims.";
        private Brush _statusBrush = Brushes.LightGray;

        public WarrantyClaimsViewModel(ICrudApiClient crudApi)
        {
            _crudApi = crudApi;
        ...
        public ObservableCollection<WarrantyClaimDto> Items { get; } = new();
        ...
        {
            IsLoading = true;
            Status = "Loading warranty claims...";
            StatusBrush = Brushes.LightGray;
            try
            {
                var items = await _crudApi.GetAllAsync<WarrantyClaimDto>("api/warranty");
                Items.Clear();

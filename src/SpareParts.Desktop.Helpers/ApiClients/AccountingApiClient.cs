...
namespace SpareParts.Desktop.Wpf
{
    public sealed class AccountingApiClient : FeatureApiClientBase, IAccountingApiClient
    {
        ...
        public Task<List<StatementPartyDto>> GetStatementPartiesAsync()
            => RetrieveAsync<StatementPartyDto>("api/accounting/statement-parties");
        ...
        public Task<StatementOfAccountReportDto> GetStatementOfAccountForPartyAsync(string partyType, int partyId, DateTime? dateFrom = null, DateTime? dateTo = null)
            => RetrieveOneAsync<StatementOfAccountReportDto>($"api/accounting/statement-of-account/party?partyType={Uri.EscapeDataString(partyType)}&partyId={partyId}{BuildDateQuery(dateFrom, dateTo, hasExistingQuery: true)}", "Statement of account was empty.");

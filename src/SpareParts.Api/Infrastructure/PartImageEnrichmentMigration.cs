...
/// <summary>
/// Creates the dbo.PartImageEnrichment table used by the image-enrichment pipeline.
/// Tracks proposed image replacements with confidence scores, source metadata,
/// and admin-approval workflow status.
/// </summary>
public static class PartImageEnrichmentMigration
{
...
-- Idempotent column additions for future schema updates

...
namespace SpareParts.Infrastructure.Services
{
    public sealed class BusinessAssistantService
    {
        ...
        private readonly record struct DateRange(DateTime? DateFrom, DateTime? DateTo, string Label);

        private readonly record struct SlowMovingPartFilter(string BrandTerm, decimal? MinSalePrice, DateTime? PurchasedBefore)
        {
        ...
        private sealed class CustomerAssistantRow
        {
        ...
        private sealed class PurchaseOrderDraftRow
        {
        ...
        private sealed class CampaignPartRow
        {
            public int PartId { get; set; }
            public string InternalCode { get; set; } = string.Empty;
            public string PartName { get; set; } = string.Empty;
        ...
        private sealed class UnpaidCustomerRow
        {
            public int? CustomerId { get; set; }
            public string CustomerName { get; set; } = string.Empty;
            public string? Phone { get; set; }
        ...
        private sealed class PaymentReminderDraftRow
        {
        ...
        private sealed class LosingPartRow
        {
            public int PartId { get; set; }
            public string InternalCode { get; set; } = string.Empty;
            public string PartName { get; set; } = string.Empty;
        ...
        private sealed class SupplierAssistantRow
        {
        ...
        private sealed class SupplierBalanceRow
        {
            public decimal Balance { get; set; }
            public int LineCount { get; set; }
        }

        private sealed class OpenSupplierRow
        {
        ...
        private sealed class TopPaidSupplierRow
        {
            public int SupplierId { get; set; }
            public string SupplierName { get; set; } = string.Empty;
            public decimal PaidAmount { get; set; }
        ...
        private sealed class LosingCarRow
        {
        ...
        private sealed class SlowMovingPartRow
        {
            public int PartId { get; set; }
            public string InternalCode { get; set; } = string.Empty;
            public string PartName { get; set; } = string.Empty;

...
export const crudConfigs = {
  ...
  parts: {
    ...
    fields: [
      ...
      { key: "estimatedMarketPrice", label: "Estimated Market Price", type: "number", optional: true },
      { key: "costAllocationPercent", label: "Allocation %", type: "number", readOnly: true },
      { key: "allocatedCost", label: "Allocated Cost", type: "number", readOnly: true },
      { key: "minimumSellPrice", label: "Minimum Price", type: "number", readOnly: true },
      { key: "fastSalePrice", label: "Fast Sale Price", type: "number", readOnly: true },
      { key: "wholesalePrice", label: "Wholesale Price", type: "number", readOnly: true },
      { key: "recommendedPrice", label: "Recommended Price", type: "number", readOnly: true },
      { key: "pricingStatus", label: "Pricing Status", readOnly: true },

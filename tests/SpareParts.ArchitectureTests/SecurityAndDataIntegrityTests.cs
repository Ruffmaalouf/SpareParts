...
public class SecurityAndDataIntegrityTests
{
    ...
    {
        var service = new ReportBuilderService(null!, InMemorySqliteConnectionFactory.NoTenant);
        ...
        using (var connection = factory.CreateConnection())
        {
            connection.Execute(
                @"INSERT INTO Users (Id, Username, FullName, Email, PasswordHash, RoleId, TenantId, IsActive)
                  VALUES (11, 'google:disabled-user', 'Disabled User', 'disabled@example.com', 'unused', 4, 1, 0);");
        }
